    ...
    return {
      providers: [
        // ═══ 国内大模型 ═══
        {
          ...
          name: '阿里云百炼（通义千问）',
          models: [
            'qwen-max-latest', 'qwen-plus', 'qwen-turbo',
            ...
            'qwen2-audio-instruct', 'qwen-turbo-latest',
          ],
        ...
        },
        {
          ...
          models: [
            ...
            'glm-4-flash', 'glm-4-flashx', 'glm-4-long', 'glm-4-alltools',
        ...
        },
        {
          ...
          name: '字节跳动豆包（火山引擎）',
          models: [
            'doubao-pro-32k', 'doubao-pro-128k', 'doubao-lite-32k', 'doubao-lite-128k',
            'doubao-pro-256k', 'doubao-1.5-vision-pro-32k',
          ],
        ...
        },
        {
          ...
          models: [
            'claude-sonnet-4-20250514', 'claude-4-opus-20250514',
        ...
        },
        {
          id: 'xai-grok',
          name: 'xAI（Grok）',
          models: ['grok-3-beta', 'grok-3-mini-beta', 'grok-2-vision-2', 'grok-2-1212'],
